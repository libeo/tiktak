Localization.define('il_IL') do |l|
  ...
  l.store "(250x50px should look good. The logo will be shown up top instead of the Tik-Tak one, and on your login page.)", "(250x50px ייראה טוב. הלוגו יוצג במקום הלוגו הנוכחי, ובעמוד הלוגין.)"
