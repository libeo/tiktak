Localization.define('es_ES') do |l|
  ...
  l.store "Open to everyone using Tik-Tak", "Abierto a todos los que usan Tik-Tak" # Francisco Benavent
  ...
  l.store "Welcome to Tik-Tak. To get started, follow the steps below.", "Bienvenido a Tik-Tak. Para comenzar, siga los pasos a continuación." # Keber Flores
  ...
  l.store "(250x50px should look good. The logo will be shown up top instead of the Tik-Tak one, and on your login page.)", "(Se recomienda un tamaño de imagen de 250x50px. El logotipo se mostrará en la cabecera, en lugar del de ClockingIt, y en la página de inicio de sesión.)"
  ...
  l.store "Next up is %s. You can also do it by clicking the %s button up in the top menu. For more information about tasks, have a look at %s on the Tik-Tak Wiki.", "Lo siguiente es %s. También puede hacerlo cliqueando el botón %s en el menú superior. Para más información sobre tareas, mire %s en el Tik-Tak Wiki." # Keber Flores
  ...
  l.store "If you require further help, check the <a href=\"http://forum.tik-tak.com\" target=\"_new\">forum</a>, <a href=\"http://wiki.tik-tak.com\" target=\"_new\">wiki</a> or email us at <a href=\"mailto:support@tik-tak.com\">support@tik-tak.com</a>.", "Si necesita más ayuda, revise el <a href=\"http://forum.tik-tak.com\" target=\"_new\">foro</a>,  <a href=\"http://wiki.tik-tak.com\" target=\"_new\">wiki</a> o envíenos un email a <a href=\"mailto:support@tik-tak.com\">support@tik-tak.com</a>." # Juan Camilo
  l.store "Next up is %s. You can also do it by clicking the %s button up in the top menu. For more information about tasks, have a look at <a href=\"http://wiki.tik-tak.com/wiki:tutorial#tasks\" target=\"_new\">the documentation</a> on the Tik-Tak Wiki.", "Lo siguiente es %s. También puede hacerlo mediante un click sobre el botón %s en el menú. Para más información sobre tareas, mire <a href=\"http://wiki.tik-tak.com/wiki:tutorial#tasks\" target=\"_new\">la documentación</a>en la Wiki deTik-Tak ." # Jorge
end
