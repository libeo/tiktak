Localization.define('de_DE') do |l|
  ...
  l.store "Open to everyone using Tik-Tak", "Offen für jeden der Tik-Tak benutzt" # Tim Zech
  ...
  l.store "Welcome to Tik-Tak. To get started, follow the steps below.", "Willkommen bei Tik-Tak. To get started, follow the steps below." # Tim Zech
  ...
  l.store "Changes done here will not go live until admin@tik-tak.com is notified for verification.", "Änderungen hier werden nicht Veröffentlicht bis admin@tik-tak.com für die Verifikation benachrichtigt wurde." # Tim Zech
  ...
  l.store "(250x50px should look good. The logo will be shown up top instead of the Tik-Tak one, and on your login page.)", "(250x50px sollte gut aussehen. Das Markenzeichen wird anstatt dem von tik-tak.com zuoberst auf jeder Seite angezeigt.)"
  ...
  l.store "Next up is %s. You can also do it by clicking the %s button up in the top menu. For more information about tasks, have a look at %s on the Tik-Tak Wiki.", "Das nächste ist %s. Dies können Sie auch erreichen, indem Sie %s im oberen Menü anklicken. Für weitere Informationen über Aufgaben schauen sie sich %s im Tik-Tak Wiki an." # Tim Zech
  ...
  l.store "If you require further help, check the <a href=\"http://forum.tik-tak.com\" target=\"_new\">forum</a>, <a href=\"http://wiki.tik-tak.com\" target=\"_new\">wiki</a> or email us at <a href=\"mailto:support@tik-tak.com\">support@tik-tak.com</a>.", "Wenn Sie weitere Hilfe benötigen, schauen Sie im <a href=\"http://forum.tik-tak.com\" target=\"_new\">Forum</a>, <a href=\"http://wiki.tik-tak.com\" target=\"_new\">Wiki</a> nach oder senden Sie eine E-Mail an <a href=\"mailto:support@tik-tak.com\">support" # Tim Zech
  l.store "Next up is %s. You can also do it by clicking the %s button up in the top menu. For more information about tasks, have a look at <a href=\"http://wiki.tik-tak.com/wiki:tutorial#tasks\" target=\"_new\">the documentation</a> on the Tik-Tak Wiki.", "Als nächstes kommt %s. Du kannst dieses erreichen, indem du %s im oberen Menu drückst. Für weitere Informationen über Aufgaben, schaue in <a href=\"http://wiki.tik-tak.com/wiki:tutorials#tasks\" target=\"_new\">die Dokumentation</a> in der Tik-Tak Wiki." # Phillipp Koops
end
