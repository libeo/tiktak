Localization.define('eu_ES') do |l|
  ...
  l.store "(Won't be resized, 150x50px should look good. The logo will be shown up top instead of the Tik-Tak one, and on your login page.)", "(Ez da tamainaz aldatuko, 150x150px tamainakoa egoki ikusik oda. Logoa goiburuan eta sarrerako orrian ikusiko da, Tik-Tak-en ordez.)"
