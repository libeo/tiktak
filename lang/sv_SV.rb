Localization.define('sv_SV') do |l|
  ...
  l.store "Open to everyone using Tik-Tak", "Öppet för alla som använder Tik-Tak" # Daniel Westergren
  ...
  l.store "Welcome to Tik-Tak. To get started, follow the steps below.", "Välkommen till Tik-Tak. För att börja, följ stegen nedan." # Daniel Westergren
  ...
  l.store "(250x50px should look good. The logo will be shown up top instead of the Tik-Tak one, and on your login page.)", "(250x50px är den optimala storleken. Logon kommer att visas i övre vänstra hörnet, istället för Tik-Tak logon, och även på loginsidan.)"
  ...
  l.store "Next up is %s. You can also do it by clicking the %s button up in the top menu. For more information about tasks, have a look at %s on the Tik-Tak Wiki.", "Nästa är %s. Du kan även göra detta genom att klicka på %s i toppmenyn. För mer information om uppgifter, klolla in %s i Tik-Tak-wikin." # Daniel Westergren
  ...
  l.store "If you require further help, check the <a href=\"http://forum.tik-tak.com\" target=\"_new\">forum</a>, <a href=\"http://wiki.tik-tak.com\" target=\"_new\">wiki</a> or email us at <a href=\"mailto:support@tik-tak.com\">support@tik-tak.com</a>.", "Om du behöver mer hjälp, kolla in <a href=\"http://forum.tik-tak.com\" target=\"_new\">forumet</a>, <a href=\"http://wiki.tik-tak.com\" target=\"_new\">wikin</a> eller maila oss på <a href=\"mailto:support@tik-tak.com\">support@tik-tak.com</a>." # Daniel Westergren
  l.store "Next up is %s. You can also do it by clicking the %s button up in the top menu. For more information about tasks, have a look at <a href=\"http://wiki.tik-tak.com/wiki:tutorial#tasks\" target=\"_new\">the documentation</a> on the Tik-Tak Wiki.", "Nästa är %s. Du kan även göra detta genom att klicka på knappen %s i toppmenyn. Flr mer information om uppgifter, kolla in <a href=\"http://wiki.tik-tak.com/wiki:tutorial#tasks\" target=\"_new\">dokumentationen</a> i Tik-Tak-wikin." # Daniel Westergren
end
