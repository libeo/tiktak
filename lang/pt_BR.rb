Localization.define('pt_BR') do |l|
  ...
  l.store "Open to everyone using Tik-Tak", "Aberto para todos, usando Tik-Tak" # Yeltsin Lima
  ...
  l.store "Welcome to Tik-Tak. To get started, follow the steps below.", "Bem Vindo ao Tik-Tak. Para iniciar, siga os passos abaixo." # Allan Balliberdin
  ...
  l.store "(250x50px should look good. The logo will be shown up top instead of the Tik-Tak one, and on your login page.)", "(Recomenda-se uma imagem de tamanho 250x50px. O logotipo será apresentado no cabeçalho, no lugar de ClockingIt, e na página de login.)" # Pedro Henrique Braga Moreira
  ...
  l.store "Next up is %s. You can also do it by clicking the %s button up in the top menu. For more information about tasks, have a look at %s on the Tik-Tak Wiki.", "O próximo passo é %s. Você também pode fazer isso clicando em %s no menu superior. Para mais informações sobre tarefas, dê uma olhada em %s em Tik-Tak Wiki." # Pedro Henrique Braga Moreira
  ...
  l.store "If you require further help, check the <a href=\"http://forum.tik-tak.com\" target=\"_new\">forum</a>, <a href=\"http://wiki.tik-tak.com\" target=\"_new\">wiki</a> or email us at <a href=\"mailto:support@tik-tak.com\">support@tik-tak.com</a>.", "Se você desejar mais informações, visite <a href=\"http://forum.tik-tak.com\" target=\"_new\">forum</a>, <a href=\"http://wiki.tik-tak.com\" target=\"_new\">wiki</a> ou envie e-mail para <a href=\"mailto:support@tik-tak.com\">support@tik-tak.com</a>." # Pedro Henrique Braga Moreira
  l.store "Next up is %s. You can also do it by clicking the %s button up in the top menu. For more information about tasks, have a look at <a href=\"http://wiki.tik-tak.com/wiki:tutorial#tasks\" target=\"_new\">the documentation</a> on the Tik-Tak Wiki.", "Próximo passo é %s. Você também pode fazer isso clicando em %s no menu superior. Para mais informações sobre tarefas, visite <a href=\"http://wiki.tik-tak.com/wiki:tutorial#tasks\" target=\"_new\">a documentação</a> em Tik-Tak Wiki." # Pedro Henrique Braga Moreira
end
