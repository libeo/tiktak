Localization.define('fr_FR') do |l|
 ...
 l.store "Task created", "Tâche créee"
 l.store "Task completed", "Tâche completée"
 l.store "Task deleted", "Tâche supprimée"
 l.store "Task modified", "Tâche modifiée"
 l.store "Task comment", "Tâche ajout d'un commentaire"
 l.store "Task work added", "Tâche temps ajouté"
 l.store "Task assigned", "Tâche assignation"
 l.store "Task archived", "Tâche archivée"
 l.store "Task restored", "Tâche restaurée"
 l.store "Page created", "Page créee"
 l.store "Page deleted", "Page supprimée"
 l.store "Page renamed", "Page renommée"
 l.store "Page modified", "Page modifiée"
 l.store "Wiki created", "Wiki crée"
 l.store "Wiki modified", "Wiki modifié"
 l.store "File uploaded", "Fichier téléversé"
 l.store "File deleted", "Fichier supprimé"
 l.store "Access granted", "Accès accordé"
 l.store "Acces revoked", "Accès révoqué"
 l.store "Scm commit", "Scm commit"
 l.store "Project completed", "Projet complété"
 l.store "Project reverted", "Projet réouvert"
 l.store "Milestone completed", "Jalon complété"
 l.store "Milestone reverted", "Jalon réouvert"
 l.store "Forum new post", "Forum nouveau post"
 l.store "Resource password requested", "Ressource mot de passe demandé"
 l.store "Resource change", "Ressource changement"
 ...
 l.store "Keyword", "Recherche par mot"
 l.store "Created by, no assignments", "Crée par, sans assignation"
 l.store "Created by - no assignments", "Crée par - sans assignation"
 l.store "Other", "Autre"
 l.store "Task number", "Numéro de tâche"
 l.store "Tasks with no users assigned", "Tâches sans assignation"
 l.store "Non-Assigned Tasks", "Tâches sans assignation"
 ...
 l.store "Tag name", "Recherche par mot clé"
 ...
 l.store "User name", "Nom d'utilisateur"
 ...
 l.store "Client name", "Nom du client"
 ...
 l.store "Status name", "Nom du status"
 ...
 l.store "Project name", "Nom du projet"
 ...
 l.store "Filter legend", "Légende du filtre"
 ...
 l.store "Milestone name", "Nom du jalon"
 ...
 l.store "Notification other info", "Informations supplémentaires : "
 l.store ", this topic is locked.", ", ce sujet est verrouillé." # Lancrey
 ...
 l.store "Notification new project", "Bonjour,\n\nUn nouveau project vient juste d'être crée. Voici les détails :"
 ...
 l.store "Open to everyone using Tik-Tak", "Rendre public à tous les utilisateurs de Tik-Tak" # Brice
 ...
 l.store "Welcome to Tik-Tak. To get started, follow the steps below.", "Bienvenue sur Tik-Tak. Pour bien débuter, suivez les étapes ci-dessous." # Brice
 ...
 l.store "(250x50px should look good. The logo will be shown up top instead of the Tik-Tak one, and on your login page.)", "(250x50px recommandé. Ce logo remplacera celui de Tik-Tak et sera également affiché sur la page de connexion.)"
 ...
 l.store "Next up is %s. You can also do it by clicking the %s button up in the top menu. For more information about tasks, have a look at %s on the Tik-Tak Wiki.", "L'étape suivante est la %s. Vous pouvez également faire cela en cliquant sur le bouton %s dans le menu du haut. Pour des informations complémentaires sur les tâches, consultez %s sur le Wiki Tik-Tak." # Brice
 l.store "The first step is to %s. Don't worry about entering real data, you can always delete the project you create and start over, once you get the hang of things.", "La première étape consiste en la %s. Vous n'êtes pas obligé de saisir de vraies données : vous pourrez effacer ce projet et en créer un nouveau une fois que vous serez familiarisé avec Tik-Tak." # Brice
 l.store "The first step is to %s. Don't worry about entering real data, you can always delete the project you create and start over, once you get the hang of things.", "La première étape consiste en la %s. Vous n'êtes pas obligé de saisir de vraies données : vous pourrez effacer ce projet et en créer un nouveau une fois que vous serez familiarisé avec Tik-Tak." # TAMARELLE
 ...
 l.store "Next up is %s. You can also do it by clicking the %s button up in the top menu. For more information about tasks, have a look at <a href=\"http://wiki.tik-tak.com/wiki:tutorial#tasks\" target=\"_new\">the documentation</a> on the Tik-Tak Wiki.", "L'étape suivante : %s. Vous pouvez aussi cliquer le bouton %s dans le menu du haut. Pour plus d'informations au sujet des tâches, consultez <a href=\"http://wiki.tik-tak.com/wiki:tutorial#tasks\" target=\"_new\">la documentation</a> sur le Wiki Tik-Tak." # Brice
 l.store "If you require further help, check the <a href=\"http://forum.tik-tak.com\" target=\"_new\">forum</a>, <a href=\"http://wiki.tik-tak.com\" target=\"_new\">wiki</a> or email us at <a href=\"mailto:support@tik-tak.com\">support@tik-tak.com</a>.", "Pour obtenir de l'aide supplémentaire, consultez le <a href=\"http://forum.tik-tak.com\" target=\"_new\">forum</a>, <a href=\"http://wiki.tik-tak.com\" target=\"_new\">wiki</a> ou écrivez à <a href=\"mailto:support@tik-tak.com\">support@tik-tak.com</a>." # Brice
end
